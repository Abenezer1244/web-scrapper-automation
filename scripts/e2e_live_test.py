...
# Screenshots go to the OS temp dir — "/tmp" does not exist on Windows.
_SHOTS = tempfile.gettempdir()
...
async def full_e2e():
    async with async_playwright() as p:
        ...
        await page.screenshot(path=f"{_SHOTS}/live_01_landing.png")
        print("       PASS")
        passed += 1
        ...
        await page.screenshot(path=f"{_SHOTS}/live_02_pricing.png")
        ...
        await page.screenshot(path=f"{_SHOTS}/live_03_register.png")
        await page.click('button[type="submit"]')
        await asyncio.sleep(6)
        await page.screenshot(path=f"{_SHOTS}/live_04_after_register.png")
        ...
        await page.screenshot(path=f"{_SHOTS}/live_05_onboarding.png")
        ...
        await page.screenshot(path=f"{_SHOTS}/live_06_wizard.png")
        ...
        await page.screenshot(path=f"{_SHOTS}/live_07_admin.png")
        ...
        await page.screenshot(path=f"{_SHOTS}/live_08_scrapers.png")
        ...
        await asyncio.sleep(3)
        await page.screenshot(path=f"{_SHOTS}/live_09_results.png")
        body = await page.text_content("body")
        ...
        await page.screenshot(path=f"{_SHOTS}/live_10_settings.png")
        pw_ok = "10" in pw_ph
        ...
        await page.screenshot(path=f"{_SHOTS}/live_11_download.png")
