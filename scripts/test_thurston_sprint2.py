"""Sprint 2 verification: Thurston County probate via EagleWebScraper.

Thurston runs at eagleweb.co.thurston.wa.us — clearly an EagleWeb portal,
so the shared template should work out of the box like Spokane.
"""
import asyncio
import os
import sys
...
async def main() -> int:
    ...
    print(f"\n=== Thurston WA probate (Sprint 2 verify): {date_from} to {date_to} ===\n", flush=True)
